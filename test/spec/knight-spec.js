...
(function() {
  define(['mydash', 'jFns', 'specConstants', 'constants', 'constructors', 'utilities', 'knight'], function(_, j, sc, c, g, u, n) {
    ...
    return descr('test knight.cough')(function() {
      var bd1, bd2, bd3, chart1, chart2, chart3, gen_hyphen_chart2, knight, no_hyphen_castling_hyphen_rts, pos1, results1, results2, results3, unset_hyphen_passant_hyphen_pos;
      ...
      bd1 = '---------------------------n------------------------------------';
      chart1 = gen_hyphen_chart2(bd1);
      results1 = [[4, 5], [4, 1], [2, 5], [2, 1], [5, 4], [5, 2], [1, 4], [1, 2]];
      bd2 = '----------p-p----p---p-----n-----p---p----p---------------------';
      chart2 = gen_hyphen_chart2(bd2);
      results2 = [[5, 4]];
      bd3 = '----------P-p----P---p-----n-----p---p----p---------------------';
      chart3 = gen_hyphen_chart2(bd3);
      ...
      t('test n.getPotentialKingAttacks')(function() {
        ...
        return to_hyphen_equal(results1)(fn(bd3)(pos1));
      });
      t('test n.getPotentialMoves')(function() {
        var fn;
        fn = n.getPotentialMoves;
        to_hyphen_equal(results1)(fn(chart1, knight));
        to_hyphen_equal(results2)(fn(chart2, knight));
        return to_hyphen_equal(results3)(fn(chart3, knight));
      });
      t('test n.modifyCastlingRights')(function() {
        var Kkq, chart4, fn;
        fn = n.modifyCastlingRights;
        to_hyphen_equal(no_hyphen_castling_hyphen_rts)(fn(chart1));
        Kkq = 'Kkq';
        chart4 = g.generate_hyphen_chart2({
          board: bd1,
          source: pos1,
          castlingRights: Kkq,
          passantPosition: unset_hyphen_passant_hyphen_pos
        });
        return to_hyphen_equal(Kkq)(fn(chart4));
      });
      t('test n.move')(function() {
        var bd4, fn, tgt;
        fn = n.move;
        bd4 = '-n--------P-p----P---p-----------p---p----p---------------------';
        tgt = g.generate_hyphen_position(0, 1);
        return to_hyphen_equal(bd4)(fn(chart3)(tgt));
      });
      t('test n.setPassantPosition')(function() {
        var chart5, fn;
        fn = n.setPassantPosition;
        to_hyphen_equal(unset_hyphen_passant_hyphen_pos)(fn(chart1));
        ...
        return to_hyphen_equal(unset_hyphen_passant_hyphen_pos)(fn(chart5));
      });
      return t('test n.setPromotionPosition')(function() {
        var fn;
        fn = n.setPromotionPosition;
        return to_hyphen_equal(c.unset_hyphen_promotion_hyphen_pos)(fn(chart1));
      });
    });
  });
