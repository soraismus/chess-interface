...
(function() {
  define(['mydash', 'jFns', 'specConstants', 'constants', 'constructors', 'utilities', 'king'], function(_, j, sc, c, g, u, k) {
    ...
    return descr('test king.cough')(function() {
      var bd, bd3, bd4, chart1, chart2, chart2_1, ctx, factory, gen_hyphen_pos, initial_hyphen_board, invalid_hyphen_board, invalid_hyphen_chessman, invalid_hyphen_pos, map, passant, path, pos1, pos2, pos3, rts, setting, src, tgt;
      bd = sc.boards[0];
      chart1 = sc.charts[0];
      chart2 = sc.charts[1];
      ...
      t('test k.getPotentialKingAttacks')(function() {
        ...
        return to_hyphen_equal(res)(fn(bd4)(gen_hyphen_pos(0, 4)));
      });
