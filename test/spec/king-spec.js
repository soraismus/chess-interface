...
(function() {
  define(['jFns', 'constants', 'constructors', 'utilities', 'king', 'game-service'], function(j, c, g, u, k, gs) {
    ...
    return descr('test king.cough')(function() {
      ...
      t('test k.getPotentialMoves')(function() {
        ...
        fn = function(bd, src, rts) {
          return k.getPotentialMoves(bd, src, rts, void 0, void 0, gs.attackable_question_);
        };
        bd3 = '----k-----------------------------K-----------------------------';
