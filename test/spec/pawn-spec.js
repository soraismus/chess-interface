...
(function() {
  define(['jFns', 'specConstants', 'constants', 'constructors', 'pawn'], function(j, sc, c, g, p) {
    ...
    return descr('test pawn.cough')(function() {
      ...
      t('test p.move')(function() {
        ...
        to_hyphen_equal(res)(fn(initial_hyphen_board, src1, c.unset_hyphen_passant_hyphen_pos)(tgt1));
