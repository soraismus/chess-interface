...
(function() {
  define(['mydash', 'jFns', 'constants', 'constructors', 'utilities', 'stepper'], function(_, j, c, g, u, st) {
    ...
    return descr('test stepper.cough')(function() {
      ...
      return t('test st.getBasicPotentialMoves')(function() {
        var bd1, bd2, bd3, chart1, chart2, chart3, fn, gen_hyphen_chart2, local_hyphen_pos, potential_hyphen_moves, potential_hyphen_moves2, potential_hyphen_moves3;
        ...
        to_hyphen_equal(potential_hyphen_moves)(fn(chart1, c.knight));
        bd2 = '----------p-p----p---p-----n------------------------------------';
        chart2 = gen_hyphen_chart2(bd2);
        potential_hyphen_moves2 = [[4, 5], [4, 1], [5, 4], [5, 2]];
        to_hyphen_equal(potential_hyphen_moves2)(fn(chart2, c.knight));
        bd3 = '---------------------------K------------------------------------';
        chart3 = gen_hyphen_chart2(bd3);
        potential_hyphen_moves3 = [[4, 4], [4, 3], [4, 2], [3, 4], [3, 2], [2, 4], [2, 3], [2, 2]];
        return to_hyphen_equal(potential_hyphen_moves3)(fn(chart3, c.king));
      });
    });
  });
