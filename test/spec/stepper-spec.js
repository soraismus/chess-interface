...
(function() {
  define(['mydash', 'jFns', 'constants', 'constructors', 'utilities', 'stepper'], function(_, j, c, g, u, st) {
    ...
    return descr('test stepper.cough')(function() {
      return t('test st.getBasicPotentialMoves2')(function() {
        var bd1, bd2, bd3, fn, local_hyphen_pos, potential_hyphen_moves, potential_hyphen_moves2, potential_hyphen_moves3;
        fn = st.getBasicPotentialMoves2;
        local_hyphen_pos = g.generate_hyphen_position(3, 3);
        bd1 = '---------------------------n------------------------------------';
        potential_hyphen_moves = [[4, 5], [4, 1], [2, 5], [2, 1], [5, 4], [5, 2], [1, 4], [1, 2]];
        to_hyphen_equal(potential_hyphen_moves)(fn(bd1, local_hyphen_pos, void 0, void 0, c.knight));
        bd2 = '----------p-p----p---p-----n------------------------------------';
        potential_hyphen_moves2 = [[4, 5], [4, 1], [5, 4], [5, 2]];
        to_hyphen_equal(potential_hyphen_moves2)(fn(bd2, local_hyphen_pos, void 0, void 0, c.knight));
        bd3 = '---------------------------K------------------------------------';
        potential_hyphen_moves3 = [[4, 4], [4, 3], [4, 2], [3, 4], [3, 2], [2, 4], [2, 3], [2, 2]];
        return to_hyphen_equal(potential_hyphen_moves3)(fn(bd3, local_hyphen_pos, void 0, void 0, c.king));
      });
    });
  });
