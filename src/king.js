...
(function() {
  define(['base-helpers', 'constants', 'constructors', 'extractors', 'utilities', 'stepper', 'assertions'], function(_, c, g, x, u, stepper_hyphen_fns, v) {
    ...
    castle = function(bd, src, tgt) {
      var basicMove, bd_hyphen_after_hyphen_king_hyphen_moves, rook_hyphen_src, rook_hyphen_tgt, _ref1;
      basicMove = pf.basicMove;
      _ref1 = rook_hyphen_castling_hyphen_path(tgt), rook_hyphen_src = _ref1[0], rook_hyphen_tgt = _ref1[1];
      bd_hyphen_after_hyphen_king_hyphen_moves = basicMove(bd, src)(tgt);
      return basicMove(bd_hyphen_after_hyphen_king_hyphen_moves, rook_hyphen_src)(rook_hyphen_tgt);
    };
    ...
    non_hyphen_castling_hyphen_move = function(bd, src, tgt) {
