...
(function() {
  define(['base-helpers', 'constants', 'constructors', 'extractors', 'utilities', 'stepper', 'assertions'], function(_, c, g, x, u, stepper_hyphen_fns, v) {
    ...
    getPotentialKingAttacks = function(bd, src, rts) {
      ...
      return getPotentialMoves(bd, src, rts);
    };
    getPotentialMoves = function(bd, src, rts) {
      ...
      basic_hyphen_moves = pf.getBasicPotentialMoves(bd, src, rts, void 0, c.king);
