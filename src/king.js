...
(function() {
  define(['base-helpers', 'constants', 'constructors', 'extractors', 'utilities', 'stepper', 'assertions'], function(_, c, g, x, u, stepper_hyphen_fns, v) {
    var K, KQ, NO, Q, c1, c1_hyphen_key, c8, c8_hyphen_key, castle, castling_hyphen_permitted_question_, castling_hyphen_tgts, castling_question_, g1, g1_hyphen_key, g8, g8_hyphen_key, gen_hyphen_pos, getPotentialKingAttacks, get_hyphen_potential_hyphen_castling_hyphen_moves, k, king_hyphen_castling_hyphen_tgt_hyphen_files, king_hyphen_castling_hyphen_tgts, kq, modifyCastlingRights, new_hyphen_castling_hyphen_rts, no_hyphen_rts, pf, possible_hyphen_rook_hyphen_paths, public_hyphen_fns, q, rook_hyphen_castling_hyphen_path, rook_hyphen_castling_hyphen_srcs, rook_hyphen_castling_hyphen_tgts, t0, t1, t12, t2, t3, t34, t4, _ref;
    KQ = 'KQ';
    kq = 'kq';
    K = 'K';
    Q = 'Q';
    ...
    pf.getPotentialMoves = (function(getPotentialMoves) {
      return function(bd, src, rts) {
        var basic_hyphen_moves, king_hyphen_color;
        v.vow_hyphen_board(bd);
        v.vow_hyphen_position(src);
        v.vow_hyphen_castling_hyphen_right_hyphen_set(rts);
        king_hyphen_color = x.color_hyphen_at(bd)(src);
        basic_hyphen_moves = getPotentialMoves(bd, src, void 0, void 0, c.king);
