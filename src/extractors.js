...
(function() {
  define(['mydash', 'constants', 'types', 'assertions'], function(_, c, y, v) {
    var board_hyphen_from, castling_hyphen_rights_hyphen_from, chessman_hyphen_type_hyphen_at, chessman_hyphen_type_hyphen_from, chessman_hyphen_type_hyphen_of, chessmen_hyphen_from, color_hyphen_at, color_hyphen_of, colors_hyphen_at, corresponding_hyphen_black_hyphen_chessman, file_hyphen_of, map_hyphen_from, passant_hyphen_from, path_hyphen_from, position_hyphen_from, rank_hyphen__ampersand__hyphen_file_hyphen_from, rank_hyphen_of, split_hyphen__ampersand__hyphen_indexify, square_hyphen_at, src_hyphen_from, src_hyphen_setting_hyphen_from, tgt_hyphen_from, tgt_hyphen_setting_hyphen_from, to_hyphen_1d;
