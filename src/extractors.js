...
(function() {
  define(['mydash', 'constants', 'types', 'assertions'], function(_, c, y, v) {
    var board_hyphen_from, castling_hyphen_rights_hyphen_from, chessman_hyphen_positions_hyphen_from, chessman_hyphen_type_hyphen_at, chessman_hyphen_type_hyphen_from, chessman_hyphen_type_hyphen_of, color_hyphen_at, color_hyphen_of, colors_hyphen_at, corresponding_hyphen_black_hyphen_chessman, file_hyphen_of, map_hyphen_from, of_hyphen_color_question_, passant_hyphen_from, path_hyphen_from, position_hyphen_from, rank_hyphen__ampersand__hyphen_file_hyphen_from, rank_hyphen_of, square_hyphen_at, src_hyphen_from, src_hyphen_setting_hyphen_from, tgt_hyphen_from, tgt_hyphen_setting_hyphen_from, to_hyphen_1d, to_hyphen_2d;
    ...
    chessman_hyphen_type_hyphen_from = function(chart2) {
      v.vow_hyphen_chart2(chart2);
      return chessman_hyphen_type_hyphen_at(board_hyphen_from(chart2))(position_hyphen_from(chart2));
    };
    ...
    return {
      ...
      chessman_hyphen_type_hyphen_from: chessman_hyphen_type_hyphen_from,
