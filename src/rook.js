...
(function() {
  define(['mydash', 'constants', 'extractors', 'utilities', 'slider', 'assertions'], function(_, c, x, u, slider_hyphen_fns, v) {
    var K, KQ, KQk, KQq, Kk, Kkq, Kq, NO, Q, Qk, Qkq, Qq, k, kingside_question_, kq, modifyCastlingRights2, new_hyphen_castling_hyphen_rts, pf, public_hyphen_fns, q, which_hyphen_side_question_;
    KQk = 'KQk';
    KQq = 'KQq';
    Kkq = 'Kkq';
    Qkq = 'Qkq';
