...
(function() {
  define(['mydash', 'constants', 'extractors', 'utilities', 'slider', 'assertions'], function(_, c, x, u, slider_hyphen_fns, v) {
    var K, KQ, KQk, KQq, Kk, Kkq, Kq, NO, Q, Qk, Qkq, Qq, get_hyphen_new_hyphen_castling_hyphen_rts, k, kq, modifyCastlingRights, new_hyphen_castling_hyphen_rts, pf, public_hyphen_fns, q, reset_hyphen_modifyCastlingRights;
    KQk = 'KQk';
    KQq = 'KQq';
    Kkq = 'Kkq';
    Qkq = 'Qkq';
    ...
    modifyCastlingRights = function(chart2) {
      ...
      side = u.kingside_question_(src) ? 'kingside' : 'queenside';
