...
(function() {
  define(['mydash', 'constants', 'utilities', 'extractors', 'slider', 'king', 'rook', 'knight', 'pawn', 'assertions'], function(_, c, u, x, slider_hyphen_fns, king_hyphen_fns, rook_hyphen_fns, knight_hyphen_fns, pawn_hyphen_fns, v) {
    ...
    gen_hyphen_temp_hyphen_chart2 = function(board, rts, passant) {
      return function(pos) {
    ...
    checkmate_question_ = function(chart2, color) {};
    ...
    vulnerable_hyphen_positions_hyphen_for = function(board, color) {
      var foe_hyphen_color, foe_hyphen_positions;
      v.vow_hyphen_board(board);
      v.vow_hyphen_color(color);
      ...
      return _.meld(_.map(getPotentialKingAttacks(board))(foe_hyphen_positions));
    };
    test_hyphen_mode = {
      call: call,
