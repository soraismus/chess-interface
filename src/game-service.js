...
(function() {
  define(['mydash', 'constants', 'utilities', 'extractors', 'slider', 'king', 'rook', 'knight', 'pawn', 'assertions'], function(_, c, u, x, slider_hyphen_fns, king_hyphen_fns, rook_hyphen_fns, knight_hyphen_fns, pawn_hyphen_fns, v) {
    var call, contains, dispatch_hyphen_table, getPotentialKingAttacks, getPotentialMoves, modifyCastlingRights, move, move_hyphen_legal_question_, query_hyphen_game_hyphen_service, setPassantPosition, setPromotionPosition, test_hyphen_mode;
