...
(function() {
  define(['constants', 'utilities', 'extractors', 'slider', 'king', 'rook', 'knight', 'pawn', 'assertions'], function(c, u, x, slider_hyphen_fns, king_hyphen_fns, rook_hyphen_fns, knight_hyphen_fns, pawn_hyphen_fns, v) {
    ...
    copy = function(ctx) {
      var board, castlingRights, passantPosition, player, promotionPosition;
      board = ctx.board, player = ctx.player, castlingRights = ctx.castlingRights, passantPosition = ctx.passantPosition, promotionPosition = ctx.promotionPosition;
      return {
        board: board,
        player: player,
