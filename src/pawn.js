...
(function() {
  define(['base-helpers', 'constants', 'constructors', 'utilities', 'extractors', 'chessman', 'assertions'], function(_, c, g, u, x, chessman_hyphen_fns, v) {
    var advancing_hyphen_2_hyphen_squares_question_, at_hyphen_home_hyphen_rank_question_, at_hyphen_promotion_hyphen_rank_question_, behind, delete_hyphen_passed_hyphen_pawn, direction_hyphen_for, directions, getPotentialKingAttacks, getPotentialMoves, get_hyphen_diag_hyphen_attacks, get_hyphen_diagonal_hyphen_positions, get_hyphen_fwd_hyphen_moves, home_hyphen_ranks, move, pf, promotion_hyphen_ranks, public_hyphen_fns, setPassantPosition, setPromotionPosition;
    home_hyphen_ranks = {};
    ...
    move = function(bd, src, passant) {
      return function(tgt) {
        ...
        v.vow_hyphen_all_hyphen_positions([src, tgt]);
        v.vow_hyphen_passant_hyphen_position(passant);
        bd_hyphen_after_hyphen_basic_hyphen_move = pf.basicMove(bd, src)(tgt);
