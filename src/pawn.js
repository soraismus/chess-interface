...
(function() {
  define(['base-helpers', 'constants', 'constructors', 'utilities', 'extractors', 'chessman', 'assertions'], function(_, c, g, u, x, chessman_hyphen_fns, v) {
    var advancing_hyphen_2_hyphen_squares_question_, at_hyphen_home_hyphen_rank_question_, at_hyphen_promotion_hyphen_rank_question_, behind, delete_hyphen_passant_hyphen_if_hyphen_enpassant_hyphen_capture, delete_hyphen_passed_hyphen_pawn, direction_hyphen_for, directions, getPotentialKingAttacks, getPotentialMoves, get_hyphen_diag_hyphen_attacks, get_hyphen_diagonal_hyphen_positions, get_hyphen_fwd_hyphen_moves, home_hyphen_ranks, pf, promotion_hyphen_ranks, public_hyphen_fns, setPassantPosition, setPromotionPosition;
    home_hyphen_ranks = {};
    ...
    advancing_hyphen_2_hyphen_squares_question_ = function(src, tgt) {
      ...
      return Math.abs(u.rank_hyphen_difference(src, tgt)) > 1;
    };
    ...
    delete_hyphen_passant_hyphen_if_hyphen_enpassant_hyphen_capture = function(bd, color, set_hyphen_passant, tgt) {
      v.vow_hyphen_board(bd);
      v.vow_hyphen_color(color);
      v.vow_hyphen_all_hyphen_positions([set_hyphen_passant, tgt]);
      if (u.same_hyphen_position_question_(tgt)(set_hyphen_passant)) {
        return delete_hyphen_passed_hyphen_pawn(bd, color, set_hyphen_passant);
      } else {
        return bd;
      }
    };
    ...
    get_hyphen_diagonal_hyphen_positions = function(rank, file, dir) {
      ...
      return ([file - 1, file + 1].map(gen_hyphen_pos)).filter(u.inessent_question_);
    };
    get_hyphen_diag_hyphen_attacks = function(board, rank, file, color, dir, passant) {
      ...
      available_question_ = function(val) {
        return foe_hyphen_present_question_(val) || passant_question_(val);
      };
      color_hyphen_at = x.color_hyphen_at(board);
      diag_hyphen_attacks = get_hyphen_diagonal_hyphen_positions(rank, file, dir);
      return diag_hyphen_attacks.filter(available_question_);
    };
    ...
    getPotentialMoves = function(bd, src, rts, passant) {
      ...
      return moves.filter(u.inessent_question_);
    };
    setPassantPosition = function(pawn_hyphen_color, src, tgt) {
      var dir;
    ...
    setPromotionPosition = function(pawn_hyphen_color, tgt) {
      var tgt_hyphen_rank;
      v.vow_hyphen_color(pawn_hyphen_color);
    ...
    pf.move = (function(simple_hyphen_move) {
      return function(bd, src, passant) {
        return function(tgt) {
          var bd_hyphen_after_hyphen_basic_hyphen_move;
          v.vow_hyphen_board(bd);
          v.vow_hyphen_all_hyphen_positions([src, tgt]);
          v.vow_hyphen_passant_hyphen_position(passant);
          bd_hyphen_after_hyphen_basic_hyphen_move = simple_hyphen_move(bd, src)(tgt);
          if (u.passant_hyphen_position_hyphen_unset_question_(passant)) {
            return bd_hyphen_after_hyphen_basic_hyphen_move;
          }
          return delete_hyphen_passant_hyphen_if_hyphen_enpassant_hyphen_capture(bd_hyphen_after_hyphen_basic_hyphen_move, x.color_hyphen_at(bd)(src), passant, tgt);
        };
      };
    })(pf.move);
