...
(function() {
  define(['mydash', 'constants', 'constructors', 'utilities', 'extractors', 'chessman', 'assertions'], function(_, c, g, u, x, chessman_hyphen_fns, v) {
    var advancing_hyphen_2_hyphen_squares_question_, at_hyphen_home_hyphen_rank_question_, at_hyphen_promotion_hyphen_rank_question_, behind, delete_hyphen_passed_hyphen_pawn, direction_hyphen_for, directions, getPotentialKingAttacks, getPotentialKingAttacks2, getPotentialMoves, getPotentialMoves2, get_hyphen_diag_hyphen_attacks, get_hyphen_diagonal_hyphen_positions, get_hyphen_fwd_hyphen_moves, home_hyphen_ranks, modifyCastlingRights, move, move2, pf, promotion_hyphen_ranks, public_hyphen_fns, setPassantPosition, setPassantPosition2, setPromotionPosition, setPromotionPosition2;
    home_hyphen_ranks = {};
    ...
    getPotentialMoves = function(chart2) {
      ...
      potential_hyphen_moves = _.meld([get_hyphen_fwd_hyphen_moves(bd, rank, file, color, dir), get_hyphen_diag_hyphen_attacks(bd, rank, file, color, dir, passant)]);
