...
(function() {
  define(['mydash', 'constants', 'constructors', 'utilities', 'extractors', 'assertions'], function(_, c, g, u, x, v) {
    var advancing_hyphen_2_hyphen_squares_question_, at_hyphen_home_hyphen_rank_question_, at_hyphen_promotion_hyphen_rank_question_, basicMove, behind, direction_hyphen_for, directions, getPotentialMoves, get_hyphen_potential_hyphen_diagonal_hyphen_attacks, get_hyphen_potential_hyphen_forward_hyphen_moves, home_hyphen_ranks, modifyCastlingRights, promotion_hyphen_ranks, setPassantPosition, setPromotionPosition;
    home_hyphen_ranks = {};
    ...
    get_hyphen_potential_hyphen_diagonal_hyphen_attacks = function(board, rank, file, color, dir, passant) {
      var available_question_, color_hyphen_at, diag_hyphen_attacks, foe_hyphen_present_question_, gen_hyphen_pos, passant_question_;
      ...
      passant_question_ = function(pos) {
        return u.same_hyphen_position_question_(pos, passant);
      };
      ...
      diag_hyphen_attacks = _.map(gen_hyphen_pos)([file - 1, file + 1]);
    ...
    get_hyphen_potential_hyphen_forward_hyphen_moves = function(board, rank, file, color, dir) {
      ...
      if (!u.transparent_question_(tgt1_hyphen_color)) {
      ...
      if (!u.transparent_question_(tgt2_hyphen_color)) {
        return fwd_hyphen_moves;
      }
