...
(function() {
  define(['base-helpers', 'constants', 'types', 'assertions'], function(_, c, y, v) {
    var black_hyphen_chessman_hyphen_from, generate_hyphen_chessman, generate_hyphen_context, generate_hyphen_map, generate_hyphen_path, generate_hyphen_position, generate_hyphen_position_bang_, generate_hyphen_setting;
