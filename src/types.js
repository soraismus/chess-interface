...
(function() {
  define(['mydash', 'constants'], function(_, c) {
    var board_question_, bounded_question_, castling_hyphen_right_hyphen_set_question_, castling_hyphen_right_question_, chart_question_, chessman_hyphen_type_question_, chessman_question_, color_hyphen_pair_question_, color_question_, context_question_, empty_question_, index_question_, inessent_question_, integral_hyphen_pair_question_, king_question_, map_question_, pair_question_, passant_hyphen_position_question_, path_question_, pawn_question_, player_question_, position_hyphen_code_question_, position_question_, rook_question_, satisfies_hyphen_regex_question_, setting_question_, square_question_, type_question_, unset_hyphen_passant_hyphen_position_question_;
    ...
    position_hyphen_code_question_ = function(val) {
      return satisfies_hyphen_regex_question_(/(^-$)|(^[a-h][1-8]$)/)(val);
    };
    ...
    type_question_ = function(val) {
      return _.contains(c.general_hyphen_types)(val);
    };
    unset_hyphen_passant_hyphen_position_question_ = function(val) {
      return val === c.unset_hyphen_passant_hyphen_position;
    };
    return {
