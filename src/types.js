...
(function() {
  define(['constants'], function(c) {
    var black_question_, board_question_, boolean_question_, bounded_question_, castling_hyphen_right_hyphen_set_question_, castling_hyphen_right_question_, chessman_hyphen_type_question_, chessman_question_, color_hyphen_pair_question_, color_question_, context_question_, ctx_hyphen_props, empty_question_, hash_question_, inessent_question_, integer_question_, integral_hyphen_pair_question_, pair_question_, passant_hyphen_position_question_, pawn_hyphen_direction_question_, position_hyphen_component_question_, position_question_, satisfies_hyphen_regex_question_, square_question_, string_question_, unset_hyphen_passant_hyphen_position_question_;
    ctx_hyphen_props = ['board', 'player', 'castlingRights', 'passantPosition'];
