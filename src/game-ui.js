...
(function() {
  define(['constructors', 'extractors', 'utilities', 'game-service', 'react', 'jquery', 'jqueryUi'], function(g, x, u, gs, React, $) {
    var add_hyphen_board, add_hyphen_checkmate_hyphen_msg, add_hyphen_checkmate_hyphen_notification, add_hyphen_chessman, add_hyphen_parent_hyphen_node, add_hyphen_promotion_hyphen_msg, add_hyphen_promotion_hyphen_option, add_hyphen_promotion_hyphen_option_hyphen_image, add_hyphen_promotion_hyphen_options, add_hyphen_rank, add_hyphen_square, chessman_hyphen_on, courtiers, css_hyphen_board_hyphen_class, css_hyphen_chessman_hyphen_class, css_hyphen_square_hyphen_class, div, dom, extract_hyphen_pos, query_hyphen_game_hyphen_service, register, register_hyphen_promote, render, src_hyphen_for, trigger, type_hyphen_at, zero_hyphen_to_hyphen_seven, _ref;
    dom = React.DOM;
    div = dom.div;
    ...
    add_hyphen_checkmate_hyphen_msg = function(message) {
      return dom.span({
        id: 'checkmate-msg'
      }, message);
    };
    add_hyphen_checkmate_hyphen_notification = function(checkmate_question_, color) {
      var content, winner;
      if (!checkmate_question_) {
        return null;
      }
      winner = u.black_question_(color) ? 'White' : 'Black';
      content = "" + winner + " has won.";
      return div({
        id: 'checkmate-notification'
      }, add_hyphen_checkmate_hyphen_msg(content));
    };
    ...
    add_hyphen_parent_hyphen_node = function(player, board, prom_hyphen_pos, msg) {
      var checkmate_question_, display_hyphen_prom_hyphen_opts_question_, prev_hyphen_player;
      ...
      checkmate_question_ = msg === 'checkmate';
      return div({
        className: 'mount-point'
      }, add_hyphen_board(player, board, display_hyphen_prom_hyphen_opts_question_), add_hyphen_promotion_hyphen_options(display_hyphen_prom_hyphen_opts_question_, prev_hyphen_player), add_hyphen_checkmate_hyphen_notification(checkmate_question_, player));
    };
    ...
    render = function(ctx) {
      var board, establish_hyphen_drag_hyphen__ampersand__hyphen_drop, message, player, promotionPosition;
      board = ctx.board, player = ctx.player, promotionPosition = ctx.promotionPosition, message = ctx.message;
      ...
      React.renderComponent(add_hyphen_parent_hyphen_node(player, board, promotionPosition, message), document.getElementById('chess'));
