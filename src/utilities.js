...
(function() {
  define(['constants', 'extractors', 'types', 'assertions'], function(c, x, y, v) {
    var available_question_, black_question_, color_hyphen_absent_question_, empty_hyphen_at_question_, empty_question_, file_hyphen_difference, inessent_question_, offsets_hyphen_for, opponent_hyphen_at_question_, opponent_question_, opposing_hyphen_color, passant_hyphen_position_hyphen_set_question_, passant_hyphen_position_hyphen_unset_question_, rank_hyphen_difference, replace, same_hyphen_position_question_, to_hyphen_2d;
