...
(function() {
  define(['mydash', 'constants', 'extractors', 'types', 'assertions'], function(_, c, x, y, v) {
    ...
    castling_hyphen_matcher = function(predicate) {
      return function(color) {
        return function(path) {
          _.vowFn(predicate);
          v.vow_hyphen_color(color);
          v.vow_hyphen_path(path);
          return _.binaryIfBranch([color === c.black, predicate(path)])(['k', 'q', 'K', 'Q']);
        };
      };
    };
    ...
    file_hyphen_difference = function(_arg) {
      var src, tgt;
      tgt = _arg[0], src = _arg[1];
      v.vow_hyphen_path([tgt, src]);
    ...
    kingside_question_ = function(_arg) {
      var src, tgt;
      tgt = _arg[0], src = _arg[1];
      v.vow_hyphen_path([tgt, src]);
      return x.file_hyphen_of(src) >= 4;
    };
    kingward_question_ = function(path) {
      v.vow_hyphen_path(path);
      return file_hyphen_difference(path) > 0;
    };
