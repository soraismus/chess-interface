...
(function() {
  define(['constants', 'extractors', 'types', 'assertions'], function(c, x, y, v) {
    var available_question_, black_question_, color_hyphen_absent_question_, empty_hyphen_at_question_, empty_question_, file_hyphen_difference, inessent_question_, occupied_question_, offsets_hyphen_for, opponent_hyphen_at_question_, opponent_question_, opposing_hyphen_color, passant_hyphen_position_hyphen_set_question_, passant_hyphen_position_hyphen_unset_question_, promotion_hyphen_position_hyphen_set_question_, rank_hyphen_difference, replace, same_hyphen_position_question_, to_hyphen_2d;
    ...
    opponent_hyphen_at_question_ = function(board, pos1) {
      return function(pos2) {
        v.vow_hyphen_board(board);
        v.vow_hyphen_all_hyphen_positions([pos1, pos2]);
        return opponent_question_([pos1, pos2].map(x.color_hyphen_at(board)));
      };
    };
    ...
    promotion_hyphen_position_hyphen_set_question_ = function(promotion_hyphen_position) {
      v.vow_hyphen_promotion_hyphen_position(promotion_hyphen_position);
      return promotion_hyphen_position !== c.unset_hyphen_promotion_hyphen_pos;
    };
    rank_hyphen_difference = function(src, tgt) {
      v.vow_hyphen_all_hyphen_positions([src, tgt]);
      return (x.rank_hyphen_of(tgt)) - (x.rank_hyphen_of(src));
    ...
    replace = function(square, board, pos) {
      ...
      v.vow_hyphen_board(board);
      v.vow_hyphen_position(pos);
      idx = x.to_hyphen_1d(pos);
      return "" + (board.slice(0, idx)) + square + (board.slice(idx + 1));
    };
    ...
    return {
      ...
      promotion_hyphen_position_hyphen_set_question_: promotion_hyphen_position_hyphen_set_question_,
